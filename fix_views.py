...
# Create the new views.py content
new_views_content = '''from rest_framework.decorators import api_view
...
# Write the new views.py file
with open('course_pilot/courses/views.py', 'w', encoding='utf-8') as f:
    f.write(new_views_content)

print("✅ Created new views.py that uses CSV data directly")
print("📊 This will load all programmes from your KUCCPS_ClusterPoints_Cleaned.csv file")